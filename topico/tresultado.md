...
|Árvore B|Árvore B<sup>+</sup>|
|-|-|
|Nós 70% cheios, então:<br>&#9888; **p = (0,7 * piso (1040/22)**<br>Há apenas um nó em Nível 0.<br>n<sub>0</sub> = p - 1<br>**n<sub>0</sub> = (0,7 * piso (1040/22)) - 1**|Nós 70% cheios, então:<br>&#9888; **p = (0,7 * piso (1040/22)**<br>Há apenas um nó em Nível 0.<br>n<sub>0</sub> = (0,7 * p) - 1<br>**n<sub>0</sub> = (0,7 * piso (1033/15)) - 1**|
