...
|Árvore B|Árvore B<sup>+</sup>|
|-|-|
|Nós internos e folhas 70% cheios:<br>&#9888; p = 0,7 * p<br>&#9888; p<sub>folha</sub> = 0,7 * p<sub>folha</sub><br><br>Há (p – 1) nós em Nível 1.<br>Cada nó possui (p<sub>folha</sub> – 1) valores do campo de indexação.<br>n<sub>1</sub> = (0.7 * p) * ((0.7 * p<sub>folha</sub>) – 1)<br>**n<sub>1</sub> = (0.7 * piso (1040/22)) * ((0,7 * piso (1040/22)) – 1)**|Nós internos e folhas 70% cheios:<br>&#9888; p = 0,7 * p<br>&#9888; p<sub>folha</sub> = 0,7 * p<sub>folha</sub><br><br>Há (p – 1) nós em Nível 1.<br>Cada nó possui (p<sub>folha</sub>) valores do campo de indexação.<br>**n<sub>1</sub> = (0.7 * piso (1033/15)) * (0,7 * piso (1018/16))**|
