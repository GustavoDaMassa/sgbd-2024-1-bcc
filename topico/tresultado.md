...
|Árvore B|Árvore B<sup>+</sup>|
|-|-|
|Há apenas um nó em Nível 0.<br>n<sub>0</sub> = piso(0,7 * p) - 1<br>**n<sub>0</sub> = (0,7 * piso (1040/22)) - 1**|Há apenas um nó em Nível 0.<br>n<sub>0</sub> = (0,7 * p) - 1<br>**n<sub>0</sub> = (0,7 * piso (1033/15)) - 1**|
