...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#x270D; se um _bucket_ ficar vazio devido à exclusão de registro, este _bucket_ será liberado para o sistema operacional (ou seja, o bucket será removido do arquivo); então, o diretório será atualizado;<br>
